...
alpha_list=(0.1 1 10 30)
rho1_list=(0.3 0.5 0.8 0.9 0.99)
rho2_list=(0.5 0.9 0.99 0.999)
method='adam'
...
do
cat > ${method}_${alpha}_${rho1}_${rho2}.py << EOF
...
if __name__ == '__main__':
    ...
    t1 = time.time()
    pose, energy, i = adam(pose, scorefxn, alpha_=alpha, tol=0.001, max_iter=50000, rho1=rho_1, rho2=rho_2)
    dt = time.time() - t1
