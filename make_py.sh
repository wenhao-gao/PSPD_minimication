...
methods=('vanilla_brent' 'bfgs_brent' 'conjugate_gradient_brent' 'vanilla_armijo' 'bfgs_armijo' 'conjugate_gradient_armijo')
...
if __name__ == '__main__':
    ...
    t1 = time.time()
    pose, energy, i = ${method}(pose, scorefxn, alpha_=alpha, tol=0.001, max_iter=10000)
    dt = time.time() - t1
